...
export function NicheParticles({
    className = "",
    quantity = 150, // Increased quantity for better density
    staticity = 50,
    ease = 50,
    ...
    const circleParams = (): Circle => {
        ...
        const translateX = 0;
        const translateY = 0;
        const pSize = Math.floor(Math.random() * 3) + size; // Size range: size to size+3
        const alpha = 0;
        const targetAlpha = parseFloat((Math.random() * 0.5 + 0.3).toFixed(1)); // Alpha range: 0.3 to 0.8
